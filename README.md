...
- [AREX-Skill](https://github.com/VectorSpaceLab/AREX-Skill) - A library of 5,000+ verified, executable skills distilled from ML repositories for coding and research agents.
